...
// NOTE: The whole manual/admin "Send Email" feature moved to
// /emails-handler-functions.php — the "Email" meta box (pt_add_email_meta_boxes,
// pt_add_other_fields_for_email) and the sender (pt_send_email_template), with the
// template path fixed (inc/custom-emails/), the $_POST slug whitelisted, and a
...
<?php
        ...
        // NOTE: adjust_planned_order_send_pdf() (delivery email on planned/palletways)
        // moved to /emails-handler-functions.php, alongside the new assembly email
        // that fires on order status → completed.
