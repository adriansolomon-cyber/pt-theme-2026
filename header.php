...
<header class="mainhead">
  ...
  <div class="icons">
    ...
    <?php if ( $pt_lines_open ) : ?>
      <a class="ic hphone-mob" href="tel:+441777553392" aria-label="Call us on 01777 553392"><img src="https://www.projecttimber.com/wp-content/uploads/2026/06/callback.png" alt=""></a>
    <?php else : ?>
      <button class="ic hphone-mob" type="button" data-callback aria-label="Phone lines closed — request a callback"><img src="https://www.projecttimber.com/wp-content/uploads/2026/06/callback.png" alt=""></button>
    <?php endif; ?>
