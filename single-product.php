    ...
    <div>
      ...
      <div class="cfg-summary">
        <div class="cfg-deliv-group">
          ...
          <div class="cfg-di cfg-fastline" id="cfgFastLine" hidden><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M13 2 4 14h6l-1 8 9-12h-6z"/></svg> <span><b>Dispatched within 48 hours</b> · Order by 12pm <span class="soft">· in stock at Parry Works</span></span></div>
        </div>
