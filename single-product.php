    ...
    <div>
      ...
      <div class="cfg-summary">
        <div class="cfg-deliv-group">
          ...
          <div class="cfg-di cfg-fastline" id="cfgFastLine" hidden><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M13 2 4 14h6l-1 8 9-12h-6z"/></svg><span class="cfg-fastline-t"><b>Dispatched within 48 hours</b><small>Order by 12pm · in stock at Parry Works · choose your delivery date at checkout</small></span></div>
        </div>
...
<section class="split rev" id="assembly" style="background:var(--paper)"><div class="wrap"><div class="grid">
  ...
  <div class="copy">
    ...
    <?php endif; ?>
    <?php if ( $pt_show( 'show_assembly_button', false ) ) : ?>
...
<section class="specs" id="specs"><div class="wrap">
  ...
  <!-- product.js preselects a default size on load and adds .has-size to the section,
       which reveals the figure + cards (CSS). They stay hidden until then so first
       paint never flashes generic placeholder values. -->
...
<section class="faq" id="faq"><div class="wrap">
  ...
  <?php // Default FAQs always render; ACF "pt_faqs" entries are appended after them. ?>
  ...
  <?php if ( $pt_has_rows( 'pt_faqs' ) ) : ?>
    <?php while ( have_rows( 'pt_faqs', $pt_pid ) ) : the_row(); ?>
