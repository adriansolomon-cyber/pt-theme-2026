...
<footer class="site-foot"><div class="wrap">
  <div class="top">
    ...
    <div><h4>Links</h4><ul><li><a href="<?php echo esc_url( home_url( '/terms' ) ); ?>">Terms</a></li><li><a href="<?php echo esc_url( home_url( '/privacy' ) ); ?>">Privacy</a></li><li><a href="<?php echo esc_url( home_url( '/resources' ) ); ?>">Blog</a></li><li><a href="<?php echo esc_url( pt_checkout_url() ); ?>">Checkout</a></li></ul></div>
  </div>
  <div class="pay">
