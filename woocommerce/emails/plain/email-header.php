...
<html dir="<?php echo is_rtl() ? 'rtl' : 'ltr'?>">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="https://www.projecttimber.com/wp-content/themes/projecttimber/assets/css/fonts.css">
		...
		<table class="wrapper" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
			<tr>
				<td class="wrapper-td" align="center" valign="top">
					...
					<table class="main-body test" border="0" cellpadding="0" cellspacing="0">
