...
<section class="ranges" id="ranges"><div class="wrap">
  ...
  <div class="range-grid">
    ...
    <a class="range-card" href="<?php echo esc_url( home_url( '/garden-workshops/' ) ); ?>">
      <?php if ( ! function_exists( 'auto_voucher_enabled' ) || auto_voucher_enabled() ) : ?><span class="range-badge">Premium · 10% off GM10</span><?php endif; ?>
...
<section class="tiers"><div class="wrap">
  ...
  <div class="rb-grid">
    <a class="rb-card rb-feat" href="<?php echo esc_url( home_url( '/grandmaster/' ) ); ?>">
      ...
      <div class="rb-in"><?php if ( ! function_exists( 'auto_voucher_enabled' ) || auto_voucher_enabled() ) : ?><span class="tag y">Premium · 10% off GM10</span><?php endif; ?><h3>Grandmaster</h3><p>Our heavy-duty pressure-treated range — workshops, summerhouses and cabins built to last.</p><div class="rfoot"><span class="rprice">From £1,198</span><span class="shop">Shop Grandmaster <span class="a">→</span></span></div></div>
    </a>
